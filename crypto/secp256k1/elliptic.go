...
// Package secp256k1 bsed on original elliptic, implements several standard elliptic curves over prime
// fields.
package secp256k1
...
// ScalarBaseMult). But even for AddKey and Double, it's faster to apply and
